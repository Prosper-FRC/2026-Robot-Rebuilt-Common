...
public class IntakeConstants {
    ...
    public final IntakeGains kIntakePivotGains = new IntakeGains(new PIDGains(2.5d, 0, 0), new FFGains(0, 0, 0, 0));
    public final IntakeIDs kIntakeIDs = new IntakeIDs(52, 51);
    public final IntakeSoftLimits kIntakeSoftLimits = new IntakeSoftLimits(12.0d, Rotation2d.fromRotations(-2.0d), true, true);
    public final IntakeHardLimits kIntakeHardLimits = new IntakeHardLimits(1.0d, 9.0d);
    public final double rollerVoltageActive = 10.0d;
    public final double rollerVoltageIdle = 3.0d;
    ...
    public final PIDController kSimIntakePID = new PIDController(15d, 0.0d, 0.1d);
}
