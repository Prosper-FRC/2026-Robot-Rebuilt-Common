...
private CameraIO camera;
    ...
    public Rotation2d getAlignment() {
        double desiredYaw; 
        // if blue
    ...
    public Pose2d getValidPose() {
        if (isValid) {
            return Observation;
        } else {
            return new Pose2d(new Translation2d(Double.MAX_VALUE, Double.MAX_VALUE), new Rotation2d(Double.MAX_VALUE));
        }
    }
